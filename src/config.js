export const themes = {
  ...
  export const map_variable_lookup = {
    ...
    'workplace_pop': {'geography' : 'lad', 'full_name' : 'Workplace population', 'avg': 760, 'scale': [54, 163, 238, 354, 672, 16175], 'scale_string': ["0 - 30 (thousand)", "30 - 60", "60 - 90", "90 - 120", "120 - 150"], 'scale_colours': colors.seq_5},
